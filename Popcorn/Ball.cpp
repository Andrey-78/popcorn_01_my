...
: Ball_State(EBS_Normal), Ball_Pen(0), Ball_Brush(0), Center_X_Pos(0.0), Center_Y_Pos(Start_Ball_Y_Pos), Ball_Speed(0.0),
  Rest_Distance(0.0), Ball_Direction(0), Testing_Is_Active(false), Test_Iteration(0), Rest_Test_Distance(), Ball_Rect{}, Prev_Ball_Rect{}
{
...
void ABall::Set_For_Test()
{
	...
	Set_State(EBS_Normal, 110 + Test_Iteration, 100);
